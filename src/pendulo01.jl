...
# ╔═╡ 20633457-46af-4b70-827b-1a75a5e0d48c
using DifferentialEquations, Plots, PlutoUI

# ╔═╡ 87a72eba-703f-11f0-02bb-8b74a0cdff88
md"# MECÁNICA TEÓRICA (Ejercicio 1.2.2)"

# ╔═╡ 3577a72a-7814-4ed8-9f9b-6a9aae596922
md"# Péndulo con dos masas: 'pendulo01.jl'"

# ╔═╡ 09fdf404-8b35-4243-bf1a-29e834ecf85d
md"## Carga de paquetes"

# ╔═╡ 79995598-e59f-444f-a97b-1f188237c11a
md"## Referencias:"

# ╔═╡ e534e364-3a2e-478c-a1f8-661052507f3d
md"Mecánica Teórica - [capítulo 03 (YouTube)](https://youtu.be/DxnnbrTegIw?si=EghcAW3Xi3hmFjX6) (Javier García)"

# ╔═╡ c12b4862-bad0-4546-9677-8fc4eef4bfcb
md"[Documentación de DifferentialEquations.jl](https://docs.sciml.ai/DiffEqDocs/stable/)"

# ╔═╡ 27031ee2-d1d1-4a17-bf36-516f116a0905
md"## Descripción del péndulo:"
...
md"## Sistema de dos ecuaciones diferenciales de segundo orden:"
...
md"### Conversión en un sistema de cuatro ecuaciones diferenciales de primer orden"
...
md"""
1. Gráfica combinada, que representa el ángulo que forma la varilla con la vertical, $\theta$ y su velociddad angular, $\omega = \dot{θ}$, con respecto al tiempo.
"""
...
md"""
$\ddot{θ} = -\frac{m\sin θ\cos θ}{M+m\sin^{2}θ}\dot{θ} + \frac{(M+m)g\sin θ}{b(M+m\sin^{2}θ}$
"""

# ╔═╡ 6d0402dd-3658-447b-812b-35656acc5f07
md"$f(du, u, p, t) = -\frac{p[1]\sin u \cos u}{p[2]+p[1]\sin^2 u} du + \frac{(p[2]+p[1])p[4]\sin u}{p[3](p[2]+p[1]\sin^2 u)}$"

# ╔═╡ a16c3719-f897-4d2e-85a2-a8ebdb3a1e37
md"### Código de la función:"
...
md"### Código de las ecuaciones del movimiento de la masa $m$"
...
@bind reset Button("Restablecer variables")
...
begin
	reset
	md"θ ($°$): $(@bind θd₀ Scrubbable(0.0:0.1:180.0, default=90.0))"
end
...
begin
	...
	Condiciones iniciales||
		$x$ ($m$): x_ini |
		$θ$ ($°$): $(@bind θd_ini Scrubbable(0.0:0.1:180.0, default=90.0))|
		$\dot{x}$ ($m/s$): xdot_ini|
		$\dot{theta} ($°$): θdot_ini
	"""
end
...
manifest_format = "2.0"
project_hash = "33f6649c3602c9c1ac78c42d4a7192c58543b649"
